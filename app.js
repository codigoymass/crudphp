...
function listar() {
    ...
    .then(data => {
        ...
        if(data.length > 0) {
            ...
            str = `<tr><td colspan="8" class="text-center">¡No hay items!</td></tr>`
...
function mostrar_usuario(id) {
    ...
    document.getElementById('lbl_title').innerHTML = 'Editar usuario';
...
function limpiar() {
    ...
    document.getElementById('lbl_title').innerHTML = 'Agregar usuario';
